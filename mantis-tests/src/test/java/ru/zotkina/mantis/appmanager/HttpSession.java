...
public class HttpSession {
    ...
    public boolean login(String username, String password) throws IOException {
        ...
        return body.contains(String.format("<span class=\"input\"><input id=\"username\" type=\"text\" name=\"username\" size=\"32\" maxlength=\"191\" value=\"administrator\" class=\"\" /></span>"));//"<span class=\"italic\">&s</span>",username));
    }
